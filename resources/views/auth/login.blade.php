...
<div class="w3-top">
    <div class="w3-bar w3-theme-d2">
        ...
        <div class="w3-right-align">
            @if(Route::has('login'))
                    <a href="{{ route('login') }}" class="w3-bar-item w3-button w3-teal w3-right w3-hide-small w3-hover-white">Login</a>
    ...
    <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
        @if(Route::has('login'))
            ...
            @endif
            <a href="{{ route('login') }}" class="w3-bar-item w3-button w3-hover-white w3-teal">Login</a>
        @endif
    </div>
</div>
<center>
<form method="post" action="{{ url('/login') }}">
    @csrf
<div class="w3-row-padding w3-padding-64 w3-margin" style="width: 40%">

    <div class="w3 w3-center">
        <ul class="w3-ul w3-border w3-hover-shadow">
            <li class="w3-theme">
                <p class="w3-xlarge">Login Panel</p>
            </li>
            ...
            <li class="w3-padding-16">
                ...
                <div align="right">
                    <button type="submit" class="w3-button w3-black w3-round-large w3-hover-teal">Login</button>
                </div>
            </li>
              ...
              <li class="w3-padding-16">
                  <a href="{{ route('register') }}" class="text-center">New to our site? Create Account!</a>
              </li>
