...
<div class="w3-top">
    <div class="w3-bar w3-theme-d2">
        <div class="w3-left-align">
            ...
            <a href="{{url('/')}}" class="w3-bar-item w3-button"><i class="fa fa-home w3-margin-right"></i>E-HealthCare</a>
        </div>
        <div class="w3-right-align">
            @if(Route::has('login'))
                <a href="{{ route('login') }}" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Login</a>
                @if(Route::has('register'))
                    <a href="{{ route('register') }}" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Register</a>
                @endif
            @endif
        </div>
    </div>
    ...
    <div class="w3-row-padding w3-padding-64 w3-margin" style="width: 40%; alignment: center">
        ...
        <div class="w3 w3-center">
            <ul class="w3-ul w3-border w3-hover-shadow">
                <li class="w3-theme">
                    <p class="w3-xlarge">Password Confirmation</p>
                </li>
                ...
                <li class="w3-padding-16">
                    <div align="right">
                        <button type="submit" class="w3-button w3-black w3-round-large w3-hover-teal">Confirm Password</button>
                    </div>
                </li>
                <li class="w3-padding-16 ">
