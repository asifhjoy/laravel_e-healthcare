                    ...
                    <div class="w3-container w3-half w3-border w3-hover-border-black w3-hover-shadow w3-margin" style="width: 45%">
                        <table class="w3-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{\App\Appointment::where([['clientmail',\Illuminate\Support\Facades\Auth::user()->email],['attended','0'],['unattended','0'],['cancelled','0']])->count()}}
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    {{\App\Appointment::where([['clientmail',\Illuminate\Support\Facades\Auth::user()->email],['attended','1'],['unattended','0'],['cancelled','0']])->count()}}
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    {{\App\Appointment::where([['clientmail',\Illuminate\Support\Facades\Auth::user()->email],['attended','0'],['unattended','1'],['cancelled','0']])->count()}}
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    {{\App\Appointment::where([['clientmail',\Illuminate\Support\Facades\Auth::user()->email],['attended','0'],['unattended','0'],['cancelled','1']])->count()}}
                                </td>
                            </tr>
                        </table>
                    </div>
